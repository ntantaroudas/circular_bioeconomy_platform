"""
Django settings for circular_bioeconomy_platform project.
...
SECRET_KEY = 'django-insecure-1d7lj%@)=!ops0dne1(o+uad@953@gke$m0s+qhwd4wwp=6!lj'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['ASPAX.pythonanywhere.com', 'circulareconomy-ASPAX.pythonanywhere.com', '127.0.0.1:8000', 'localhost:8000', '127.0.0.1', 'circular-bioeconomy.futural-project.eu']
