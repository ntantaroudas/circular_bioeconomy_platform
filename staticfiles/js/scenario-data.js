/* scenario-data.js - CORRECTED VERSION with accurate Excel descriptions (September 2025) */
/* 
 * ========================================
 * CORRECTIONS MADE:
 * ========================================
 * 1. Fixed Pongau Scenario 1-4 subtitles 
 * 2. Updated ALL scenario descriptions to match Excel exactly
 * 3. Fixed short descriptions to full text from Excel
 * 4. Verified German "Zukunft" usage (confirmed correct)
 * 5. Added complete energy details in descriptions
 * 6. Fixed Pongau pyrolysis scenario description
 * ========================================
 */
...
// Complete scenario data extracted from the Excel files (September 2025 update)
const scenarioData = {
  salzburg: {
    scenarios: [
      {
        ...
        description: {
          // ⚠️ CORRECTED: "material flow" instead of "mass flow", "whole region" added, values corrected
          en: 'This material flow diagram shows the current status of all wastewater treatment plants in the whole region of Salzburg. The 13,000 tonnes of sewage sludge collected in Salzburg\'s wastewater treatment plants are mainly incinerated in line with the general trend and specifically (due to the challenges posed by difficult-to-remove impurities in the sewage sludge) in accordance with legal requirements, while the 3,822 tonnes of sewage sludge ash are landfilled. When the sewage sludge is incinerated, the majority of the mass is converted into 8,918 tonnes of dry matter exhaust gases. Only a small part, around 260 tonnes of dry matter, is spread. Although further utilisation of the ash is currently being sought, no further use is planned. These are annual quantities.',
          de: 'In diesem Mengenflussdiagramm wird der IST-Status aller Kläranlagen des Bundeslandes Salzburg dargestellt. Die in den Salzburger Kläranlagen gesammelten 13.000 t TS Klärschlämme werden dem allgemeinen Trend und speziell (bedingt durch die Herausforderungen hinsichtlich schwer beseitigbaren Verunreinigungen der Klärschlämme) den gesetzlichen Vorgaben folgend hauptsächlich verbrannt und die 3.822 t TS Klärschlammasche wird deponiert. Der Großteil der Masse geht bei Verbrennung des Klärschlamms in 8.918 t TS Abgase über. Nur ein kleiner Teil, etwa 260 t TS wird ausgebracht. Bislang wird zwar eine weitere Verwertung der Asche angestrebt, doch noch ist konkret keine weitere Nutzung vorgesehen. Dies sind Jahresmengen.'
        },
        flows: [
      ...
      },
      {
        ...
        subtitle: {
          // ⚠️ CORRECTED: Added "Szenario 1:" prefix
          en: 'Szenario 1: 100% incineration according to the amendment to the Waste Incineration Ordinance (AVV, BGBl. II Nr. 389/2002)',
        ...
        description: {
          // ⚠️ CORRECTED: Full description from Excel
      ...
      },
      {
        ...
        description: {
          ...
          de: 'Dieses Stoffflussdiagramm zeigt ein Zukunftsszenario für alle Kläranlagen des Bundeslandes Salzburg. Die Salzburger Kläranlagen folgen nicht dem allgemeinen Trend, sondern den Anforderungen gemäß der Novelle der Abfallverbrennungsverordnung (AVV, BGBl. II Nr. 389/2002), wo unter diesen Umständen mindestens 60% des Phosphors zurückgewonnen werden müssen. Diese Rückgewinnung erfolgt über eine andere Verwertung durch Ausbringung auf dem Feld. Würden entsprechend dem allgemeinen Trend 100% der 13.000 Tonnen in den Salzburger Kläranlagen gesammelten Klärschlämme ausgebracht, könnten eine Reihe von Nährstoffen zurückgewonnen werden. Bei Einhaltung des gesetzlichen Minimums von 60% Phosphorrückgewinnung würden 215 Tonnen Phosphor TS zurückgewonnen werden. Zusätzlich könnten 455 Tonnen TS Stickstoff, 39 Tonnen TS Kalium, 845 Tonnen TS Kalzium, 130 Tonnen TS Magnesium und 163 Tonnen TS Schwefel in den natürlichen Kreislauf zurückgeführt werden. (Hinweis: Die zurückgewonnenen Nährstoffe beziehen sich auf eine theoretische Schätzung basierend auf typischen Gehaltsanteilen im Klärschlamm). Dies sind Jahresmengen.'
        },
        flows: [
          { from: 'A', to: 'B', flow: 13000, unit: 't TS', color: '#b56834', label: getTranslation({en: 'wastewater', de: 'Abwasser'}) },
          { from: 'B', to: 'H', flow: 11010, unit: 't TS', color: '#c94225', label: getTranslation({en: 'sewage sludge', de: 'Klärschlamm'}) },
          ...
          { from: 'B', to: 'H', flow: 358, unit: 't TS', color: '#2596be', label: getTranslation({en: 'phosphorus', de: 'Phosphor'}) },
          { from: 'B', to: 'H', flow: 215, unit: 't TS', color: '#2596be', label: getTranslation({en: 'phosphor min.', de: 'Phosphor min.'}) },
    ...
    scenarios: [
      {
        ...
        flows: [
          { from: 'A', to: 'B', flow: 625, unit: 't TS', color: '#b56834', label: getTranslation({en: 'wastewater', de: 'Abwasser'}) },
      ...
      },
      {
        ...
        subtitle: {
          // ⚠️ CORRECTED: Full subtitle from Excel
          en: 'Szenario 1 Future: Expansion, drying and incineration',
          de: 'Szenario 1 Zukunft: Erweiterung, Trocknung und Verbrennung'
        },
        shortDescription: {
          // ⚠️ CORRECTED: Complete short description mentioning Vienna-Simmering
        ...
        description: {
          // ⚠️ CORRECTED: Complete description with municipality details and Vienna-Simmering
          ...
          de: 'Dieses Stoffflussdiagramm zeigt ein Zukunftsszenario für die Kläranlage des Reinhalteverbands Salzburger Ennstal. Es ist sehr wahrscheinlich, dass die aktuelle Sammlung im bestehenden Einzugsgebiet des Reinhalteverbands Salzburger Ennstal mit dem üblichen Klärschlamm und anderen Abfällen, die in der Kläranlage weiterverarbeitet werden, um zusätzliche Klärschlammgebiete der Gemeinden Gastein, Mühlbach, RHV Zentralraum Lungau, Filzmoos, RHV St. Michael, Ramingstein und vom RHV Salzachpongau erweitert wird und auch die Sammlung von Küchen- und Speiseabfällen sowie ehemaligen tierischen Lebensmitteln gemäß ÖWAV-Richtlinien einschließen wird. Die Gesamtmenge an gesammeltem Klärschlamm und anderen Abfällen beträgt 2.575 Tonnen Trockenmasse. Zusätzlich wird vor Ort eine Trocknung durchgeführt, um das Transportgewicht von 10.300 Tonnen mit 25% Trockenmassegehalt auf 3.605 Tonnen mit 90% Trockenmassegehalt zu reduzieren. Anstatt per LKW nach Lenzing transportiert zu werden, wird diese stark reduzierte Menge über den Bahnhof Radstadt verkürzt und stattdessen per Bahn nach Wien-Simmering transportiert, wo sie zu 773 Tonnen Klärschlammasche und 1.803 Tonnen Abgas verbrannt wird. Alle Prozesse zusammen benötigen insgesamt 7.343 MWh Strom und 4.817 MWh Wärme. Andererseits werden am Standort selbst insgesamt 3.011 MWh Strom und 3.011 MWh Wärme erzeugt. (Hinweis: Energie für den Transport wurde der Einfachheit halber dem Strom zugeordnet, obwohl sie in Wirklichkeit aus Diesel und Strom besteht). Dies sind Jahresmengen.'
        },
        flows: [
      ...
      },
      {
        ...
        subtitle: {
          // ⚠️ CORRECTED: Complete subtitle
          en: 'Szenario 2: Expansion, drying and incineration + phosphorus recovery',
          de: 'Szenario 2: Erweiterung, Trocknung und Verbrennung + Phosphorrückgewinnung'
        },
        shortDescription: {
          // ⚠️ CORRECTED: Complete short description
        ...
        description: {
          // ⚠️ CORRECTED: Complete description with all municipalities and phosphorus recovery values (76 tonnes not 57)
          ...
          de: 'Dieses Stoffflussdiagramm zeigt ein Zukunftsszenario für die Kläranlage des Reinhalteverbands Salzburger Ennstal. Es ist sehr realistisch, dass die aktuelle Sammlung im bestehenden Einzugsgebiet des Reinhalteverbands Salzburger Ennstal mit dem üblichen Klärschlamm und anderen Abfällen, die in der Kläranlage weiterverarbeitet werden, um zusätzliche Klärschlammsammelgebiete aus den Gemeinden Gastein, Mühlbach, RHV Zentralraum Lungau, Filzmoos, RHV St. Michael, Ramingstein und vom RHV Salzachpongau erweitert wird und auch die Sammlung von Küchen- und Gastronomieabfällen sowie ehemaligen Lebensmitteln tierischen Ursprungs gemäß ÖWAV-Richtlinien einschließen wird. Die Gesamtmenge an gesammeltem Klärschlamm und anderen Abfällen beträgt 2.575 Tonnen Trockenmasse. Zusätzlich wird vor Ort eine Trocknung durchgeführt, um das Transportgewicht von 10.300 Tonnen mit 25% Trockenmassegehalt auf 3.605 Tonnen mit 90% Trockenmassegehalt zu reduzieren. Anstatt per LKW nach Lenzing transportiert zu werden, wird diese stark reduzierte Menge über den Bahnhof Radstadt verkürzt und stattdessen per Bahn nach Wien-Simmering transportiert, wo sie zu 773 Tonnen Klärschlammasche und 1.803 Tonnen Abgas verbrannt wird. Aus der Klärschlammasche werden 76 Tonnen Phosphor zurückgewonnen, während 697 Tonnen Klärschlammasche noch deponiert werden müssen. Insgesamt werden für alle Prozesse zusammen 7.559 MWh Strom und 4.817 MWh Wärme benötigt. Andererseits werden am Standort selbst insgesamt 3.011 MWh Strom und 3.011 MWh Wärme erzeugt. (Hinweis: Energie für den Transport wurde der Einfachheit halber dem Strom zugeordnet, obwohl sie in Wirklichkeit aus Diesel und Strom besteht). Dies sind Jahresmengen.'
        },
        flows: [
          { from: 'A', to: 'B', flow: 2575, unit: 't TS', color: '#a9a4a2', label: getTranslation({en: 'wastewater', de: 'Abwasser'}) },
          { from: 'B', to: 'D', flow: 2575, unit: 't TS', color: '#c94225', label: getTranslation({en: 'sewage sludge', de: 'Klärschlamm'}) },
          ...
          { from: 'I', to: 'H', flow: 76, unit: 't TS', color: '#2596be', label: getTranslation({en: 'phosphorus', de: 'Phosphor'}) }, // ⚠️ CORRECTED: 76 not 57
          { from: 'I', to: 'N', flow: 697, unit: 't TS', color: '#a9a4a2', label: getTranslation({en: 'ash', de: 'Asche'}) } // ⚠️ CORRECTED: 697 not 716
        ]
      },
      {
        id: 'pongau_3',
        ...
        subtitle: {
          // ⚠️ CORRECTED: lowercase "innovative"
          en: 'Szenario 3: innovative sludge treatment and humidification',
          de: 'Szenario 3: innovative Schlammbehandlung und Humifizierung'
        },
        shortDescription: {
          // ⚠️ CORRECTED: "humification" not "humidification"
        ...
        description: {
          // ⚠️ CORRECTED: Complete description with municipality details and phosphorus range (26-64 tonnes)
          ...
          de: 'Dieses Stoffflussdiagramm zeigt ein Zukunftsszenario für die Kläranlage des Reinhalteverbands Salzburger Ennstal. Es ist sehr realistisch, dass die aktuelle Sammlung im bestehenden Einzugsgebiet des Reinhalteverbands Salzburger Ennstal mit dem üblichen Klärschlamm und anderen Abfällen, die in der Kläranlage weiterverarbeitet werden, um zusätzliche Klärschlammsammelgebiete aus den Gemeinden Gastein, Mühlbach, RHV Zentralraum Lungau, Filzmoos, RHV St. Michael, Ramingstein und vom RHV Salzachpongau erweitert wird und auch die Sammlung von Küchen- und Gastronomieabfällen sowie ehemaligen Lebensmitteln tierischen Ursprungs gemäß ÖWAV-Richtlinien einschließen wird. Die Gesamtmenge an gesammeltem Klärschlamm und anderen Abfällen beträgt 2.575 Tonnen Trockenmasse. Die Stoffverwertung erfolgt durch Klärschlammhumifizierung auf entsprechenden Humifizierungsflächen. Der entstehende Humus kann dann entsprechend weiterverwertet werden. Auf diese Weise können 26-64 Tonnen TM Phosphor zurückgewonnen werden. Zusätzlich könnten 90 Tonnen TS Stickstoff, 8 Tonnen TS Kalium, 167 Tonnen TS Kalzium, 26 Tonnen TS Magnesium und 32 Tonnen TS Schwefel in den natürlichen Kreislauf zurückgeführt werden. (Hinweis: Die zurückgewonnenen Nährstoffe beziehen sich auf eine theoretische Schätzung basierend auf typischen Gehaltsanteilen im Klärschlamm). Insgesamt werden für alle Prozesse zusammen 4.483 MWh Strom und 1.807 MWh Wärme benötigt. Andererseits werden am Standort selbst insgesamt 3.011 MWh Strom und 3.011 MWh Wärme erzeugt. (Hinweis: Energie für den Transport wurde der Einfachheit halber dem Strom zugeordnet, obwohl sie in Wirklichkeit aus Diesel und Strom besteht). Dies sind Jahresmengen.'
        },
        flows: [
          // Note: Using 45 tonnes as midpoint of 26-64 range for phosphorus
          { from: 'A', to: 'B', flow: 2575, unit: 't TS', color: '#a9a4a2', label: getTranslation({en: 'wastewater', de: 'Abwasser'}) },
      ...
      },
      {
        ...
        description: {
          // ⚠️ COMPLETELY CORRECTED: New description with different values and products
          en: 'This volume flow diagram shows a future scenario for the wastewater treatment plant of the Reinhalteverband Salzburger Ennstal. It is very realistic that the current collection in the existing catchment area of the Reinhalteverband Salzburger Ennstal with the usual sewage sludge and other waste that is further processed in the sewage treatment plant will be expanded to include additional sewage sludge collection areas of the municipalities of Gastein, Mühlbach, RHV Zentralraum Lungau, Filzmoos, RHV St. Michael, Ramingstein and from the RHV Salzachpongau and will also include the collection of kitchen and catering waste and former foodstuffs of animal origin in accordance with ÖWAV guidelines. The total quantity of sewage sludge and other waste collected amounts to 2,575 tonnes of dry matter. The material is recovered through sewage sludge pyrolysis to produce biochar and heat. This produces 975 tonnes TS of biochar, 609 tonnes TS of pyrolysis oil, 366 tonnes TS of waste gases and 487 tonnes TS of landfilled ash. The pyrolysis products contain a total of 124-207 tonnes of phosphorus. In addition, 30 tonnes of nitrogen, 30 tonnes of potassium, 244 tonnes of calcium, 49 tonnes of magnesium and 18 tonnes of sulphur could be returned to the natural cycle. The 6,375 MWh of heat generated during the pyrolysis process can also be utilised accordingly. A total of 5,035 MWh of electricity and 1,807 MWh of heat are required for all processes combined. On the other hand, a total of 3,011 MWh of electricity and 9,386 MWh of heat are generated at the site itself. (Note: any energy for transport has been allocated to electricity for the sake of simplicity, even though in reality it is made up of diesel and electricity).',
          de: 'Dieses Volumenflussdiagramm zeigt ein Zukunftsszenario für die Kläranlage des Reinhalteverbands Salzburger Ennstal. Es ist sehr realistisch, dass die aktuelle Sammlung im bestehenden Einzugsgebiet des Reinhalteverbands Salzburger Ennstal mit dem üblichen Klärschlamm und anderen Abfällen, die in der Kläranlage weiterverarbeitet werden, um zusätzliche Klärschlammsammelgebiete der Gemeinden Gastein, Mühlbach, RHV Zentralraum Lungau, Filzmoos, RHV St. Michael, Ramingstein und vom RHV Salzachpongau erweitert wird und auch die Sammlung von Küchen- und Gastronomieabfällen und ehemaligen Lebensmitteln tierischen Ursprungs gemäß ÖWAV-Richtlinien einschließen wird. Die Gesamtmenge des gesammelten Klärschlamms und anderer Abfälle beträgt 2.575 Tonnen Trockenmasse. Die Stoffverwertung erfolgt durch Klärschlammpyrolyse zur Erzeugung von Biokohle und Wärme. Dabei entstehen 975 Tonnen TS Biokohle, 609 Tonnen TS Pyrolyseöl, 366 Tonnen TS Abgase und 487 Tonnen TS deponierten Asche. Die Pyrolyseprodukte enthalten insgesamt 124-207 Tonnen Phosphor. Zusätzlich könnten 30 Tonnen Stickstoff, 30 Tonnen Kalium, 244 Tonnen Kalzium, 49 Tonnen Magnesium und 18 Tonnen Schwefel in den natürlichen Kreislauf zurückgeführt werden. Die beim Pyrolyseprozess entstehenden 6.375 MWh Wärme können ebenfalls entsprechend genutzt werden. Insgesamt werden für alle Prozesse zusammen 5.035 MWh Strom und 1.807 MWh Wärme benötigt. Andererseits werden am Standort selbst insgesamt 3.011 MWh Strom und 9.386 MWh Wärme erzeugt. (Hinweis: Energie für den Transport wurde der Einfachheit halber dem Strom zugeordnet, obwohl sie in Wirklichkeit aus Diesel und Strom besteht).'
        },
        flows: [
          // ⚠️ CORRECTED: Updated flow values based on Excel description
          { from: 'A', to: 'B', flow: 2575, unit: 't TS', color: '#a9a4a2', label: getTranslation({en: 'wastewater', de: 'Abwasser'}) },
          { from: 'B', to: 'L', flow: 2575, unit: 't TS', color: '#c94225', label: getTranslation({en: 'sewage sludge', de: 'Klärschlamm'}) },
          { from: 'L', to: 'M', flow: 975, unit: 't TS', color: '#8b4513', label: getTranslation({en: 'biochar', de: 'Biokohle'}) },
          { from: 'L', to: 'Q', flow: 609, unit: 't TS', color: '#4b7c7d', label: getTranslation({en: 'pyrolysis oil', de: 'Pyrolyseöl'}) },
          ...
          // Nutrient recovery from biochar (using midpoint of phosphorus range: 165)
...
console.log('✅ Scenario data CORRECTED with accurate Excel descriptions (September 2025)');
